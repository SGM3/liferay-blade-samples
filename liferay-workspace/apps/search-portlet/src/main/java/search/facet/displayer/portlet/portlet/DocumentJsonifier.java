...
public abstract class DocumentJsonifier {
    ...
    public static String listToJson (List<Document> docs) throws JsonProcessingException {
        return listToJson(docs, false);
    }

    public static String listToJson (List<Document> docs, boolean pretty) throws JsonProcessingException {
